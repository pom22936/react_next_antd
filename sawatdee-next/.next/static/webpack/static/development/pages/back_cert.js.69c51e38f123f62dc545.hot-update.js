...
function () {
  function Stock() {
    ...
    _initializerDefineProperty(this, "temparr", _descriptor4, this);
  }
  ...
  _createClass(Stock, [{
    ...
    value: function setdata(val) {
      // console.log(val)
      temparr.push(val); // this.rest.push(val)

      console.log(temparr); // console.log(this.rest)
    }
  }]);
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "temparr", [mobx__WEBPACK_IMPORTED_MODULE_0__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
...
//# sourceMappingURL=back_cert.js.69c51e38f123f62dc545.hot-update.js.map