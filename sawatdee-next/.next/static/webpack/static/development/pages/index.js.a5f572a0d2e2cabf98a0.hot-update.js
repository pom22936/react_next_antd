...
function () {
  function Stock() {
    ...
    _initializerDefineProperty(this, "getrest", _descriptor4, this);
  }
  ...
  _createClass(Stock, [{
    ...
    key: "setdata",
    value: function setdata(temp) {
      this.rest = temp;
    }
  }, {
    key: "testfunc",
    value: function testfunc(value) {
      this.getrest = value;
    } // showdata(this.props.val){
    // }
...
}), _descriptor4 = _applyDecoratedDescriptor(_class.prototype, "getrest", [mobx__WEBPACK_IMPORTED_MODULE_0__["observable"]], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: function initializer() {
...
//# sourceMappingURL=index.js.a5f572a0d2e2cabf98a0.hot-update.js.map