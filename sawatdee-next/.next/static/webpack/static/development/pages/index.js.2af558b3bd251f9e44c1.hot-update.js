  ...
  _createClass(Index, [{
    ...
    value: function componentDidMount() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2___default.a.get(url).then(function (response) {
        ...
        console.log(_this2.props.stock.data[0]); // return dragonQuest
        //   console.log(Stock.rest)

        console.log(_this2.props.stock.getrest); // return test

        _this2.props.stock.testfunc(_this2.props.value);
      });
    }
  }, {
    key: "render",
...
//# sourceMappingURL=index.js.2af558b3bd251f9e44c1.hot-update.js.map